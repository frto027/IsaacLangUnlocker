Used for inject dll to the game.

The generated dll should be named `userenv.dll`
...
This is developed for the unofficial Chinese translation patch. But other languages still can be configured with a `config.ini` file.
